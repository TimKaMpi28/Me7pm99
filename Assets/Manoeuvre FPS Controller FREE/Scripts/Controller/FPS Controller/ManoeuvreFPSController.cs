...
namespace Manoeuvre
{
    ...
    public class ManoeuvreFPSController : MonoBehaviour
    {
        ...
        public bool canInteract = false, isInteracting = false;
        ...
        void Initialize()
        {
            ...
            gunController.source = gameObject.AddComponent<AudioSource>();
        }
        ...
        public void TakeDamageEffect()
        {
            ...
            gc_PlayerHealthManager.Instance.TakeDamage(Health.currentHealth);
        ...
        public void Die()
        {
            ...
            gc_PlayerHealthManager.Instance.DeathScreen();
    ...
    public class ManoeuvreFPSInputs
    {
        ...
        {
            if (ManoeuvreFPSController.Instance.canInteract && Input.GetKeyDown(KeyCode.E)){
                ManoeuvreFPSController.Instance.dialogue.SetActive(true);
                ManoeuvreFPSController.Instance.enabled = false;
                ManoeuvreFPSController.Instance.isInteracting = true;
            ...
            {
                ManoeuvreFPSController.Instance.gunController.Shoot();
            }
            if (Input.GetKey(ReloadKey))
            {
                ManoeuvreFPSController.Instance.gunController.Reload();
            }
